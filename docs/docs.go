    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/brotherql.LabelSize"
                            }
                        }
                    }
                }
        ...
        "/print": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Print request parameters",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.PrintPNGPayload"
                        }
                    }
                ],
                "responses": {
        ...
        "/print_png_raw": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Printer identifier (optional)",
                        "name": "printer",
                        "in": "formData"
                    },
                    {
                        "type": "string",
                        "description": "Printer model override (optional)",
                        "name": "model",
                        "in": "formData"
                    },
                    {
                        "type": "number",
                        "description": "Custom tape length in mm (endless tape only)",
                        "name": "custom_height_mm",
                        "in": "formData"
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.PrintQRRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/print_svg": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "SVG print request parameters",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.PrintSVGRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/services.FoundPrinter"
                            }
                        }
                    }
                }
        ...
        "/status": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Optional printer specification",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid request or printer not found",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
        ...
        "/test/feed": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Test request parameters",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.TestRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "api.PreviewResponse": {
            ...
            "properties": {
                ...
                "printable_height": {
                    "description": "Printable area height",
                    "type": "integer"
                },
                "printable_width": {
                    "description": "Printable area width",
                    "type": "integer"
                },
                "width": {
        ...
        "api.PrintRequest": {
            ...
            "properties": {
                ...
                "model": {
                    "description": "e.g., \"QL-800\" (optional)",
                    "type": "string"
                },
                "orientation": {
                    "type": "string"
                ...
                "printer": {
                    "description": "e.g., \"QL-800\", \"usb:001:005\" or \"file\" (optional)",
                    "type": "string"
                },
                "svg_data": {
                    "type": "string"
        ...
        "api.StatusRequest": {
            ...
            "properties": {
                "printer": {
                    "description": "Optional printer identifier. If empty, uses default printer.",
                    "type": "string",
                    "example": "usb:001:005"
                }
            }
        ...
        "api.StatusResponse": {
            ...
            "properties": {
                "raw_bytes": {
                    "description": "Number of raw bytes received",
                    "type": "integer"
                },
                "raw_hex": {
                    "description": "Full raw response in hexadecimal",
                    "type": "string"
                },
                "status": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/brotherql.PrinterStatus"
                        }
                    ]
                }
            }
        ...
        "brotherql.LabelSize": {
            "type": "object",
            "properties": {
                "dots_printable_height": {
                    "type": "integer"
                },
                "dots_printable_width": {
                    "type": "integer"
                },
                "dots_total_height": {
                    "type": "integer"
                ...
                "feed_margin": {
                    "description": "feed margin in dots required by the protocol",
                    "type": "integer"
                },
                "id": {
                    "type": "string"
        ...
        "brotherql.PrinterStatus": {
            ...
            "properties": {
                ...
                "model_name": {
                    "description": "Fields expected by frontend LabelStatus interface:",
                    "type": "string"
                },
                "phase_type": {
                    "type": "string"
        ...
        "services.FoundPrinter": {
            "type": "object",
            "properties": {
                "id": {
                    "description": "connection URI (e.g. \"usb:001:005\"); JSON \"id\" matches frontend API",
                    "type": "string"
                },
                "name": {
                    "description": "printer model (e.g. \"QL-800\"); JSON \"name\" matches frontend API",
                    "type": "string"
                }
            }
        }
